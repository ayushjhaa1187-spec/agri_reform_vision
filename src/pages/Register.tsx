        ...
        <GlassCard className="p-8 md:p-10">
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="relative py-6">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#030a06] px-2 text-gray-500 font-bold tracking-widest">Or join with</span></div>
            </div>
